...
public class ClientServices : IClientServices
{
    ...
    public async Task<ClientResponseDTO> CreateAsync(ClientCreateDTO client)
    {
        var clientEntity = new Client(client.Name, client.PhoneNumber1, client.PhoneNumber2, client.Cpf, client.BirthDate,
            client.MaritalStatus, client.Sex, client.Rg, client.DispatchingAgency, client.ReferenceName1, client.ReferenceName2,
            client.ReferenceName3, client.ReferencePhone1, client.ReferencePhone2, client.ReferencePhone3);
